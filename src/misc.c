...
"  -I, --sig-in=SIGNATURE     verify client-end by read encrypted SIGNATURE while listening\n"
...
"  -O, --sig-out=SIGNATURE    send encrypted SIGNATURE for verification while connecting\n"
